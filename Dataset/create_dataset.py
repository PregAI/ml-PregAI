...
if __name__ == "__main__":
    ...
    root_output_folder = "./Dataset raw/Yoga-82/Downloaded_dataset"
    ...
    specific_file_path = "./Dataset raw/Yoga-82/yoga_dataset_links/Bridge_Pose_or_Setu_Bandha_Sarvangasana_.txt"
    root_output_folder = "./Dataset raw/Yoga-82/Downloaded_dataset/Bridge_Pose_or_Setu_Bandha_Sarvangasana_"
